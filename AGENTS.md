...
Troadie는 부산에서 열리는 K-POP 공연 방문객을 대상으로 공연 전날, 공연 당일, 공연 다음날의 관광 일정을 추천하고 공유하는 반응형 웹 서비스입니다.

서비스명 Troadie는 Trip(여행)과 Roadie(밴드 투어를 따라다니는 스태프)를 합친 조어로, "최애의 공연을 따라 여행한다"는 팬덤 동행 컨셉을 담고 있습니다. 이전 코드네임 "Fan Route Sync"를 대체합니다.
