export const termsFixtures = {
  service: { title: '이용약관', sections: [{ heading: '서비스 이용', content: 'Troadie는 부산 콘서트 여행 일정 추천과 커뮤니티 기능을 제공합니다.' }, { heading: '이용자의 책임', content: '이용자는 정확한 정보를 입력하고 다른 이용자를 존중해야 합니다.' }] },
