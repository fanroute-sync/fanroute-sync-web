...
interface Props { comments: CommunityComment[]; userId: number | null; onLike: (id: number) => void; onReply: (id: number, author: string) => void; onDelete: (id: number) => void; disabled?: boolean }
